...
export default function Comics(){
    return(
        <div className='overflow-hidden'>
            ...
            <div className='w-full h-auto md:my-6 my-2 flex flex-col items-center justify-start absolute'>
                <img src='/comicCover.png' className='w-full h-full filter blur-sm object-cover'/>
