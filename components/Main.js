        ...
        <div className='mt-6 left-[40px] absolute flex flex-col'>
          ...
          <div className='flex flex-row items-center text-start'>
            <div className='mr-6  border-b-4 border-brand-yellow'>
                ...
                <h1 className='text-[25px] mt-8 font-kanit border-2 border-red-700 rounded-md px-4 py-2 font-medium text-white'>📢 We launch DexBattale {'(Beta)'} on 25th Januray 2023</h1>
