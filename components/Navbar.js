      ...
      <ul className='flex flex-row items-center justify-between my-4 mx-10'>
        <li>
          ...
          <div className='hidden bg-gray-700/30 py-2 px-4 backdrop-blur-md md:flex flex-row font-Kanit text-white rounded-md text-[20px]'>
            ...
            <a className="cursor-pointer hover:text-blue-400" href='/Contactus' ><h1 className='mx-4'>Contact Us </h1></a>
        ...
        <li>
        <div className='hidden py-2 px-4 backdrop-blur-md md:flex flex-row font-Kanit text-white rounded-md border border-white hover:bg-blue-400 hover:text-black  hover:font-semibold'>
