    ...
    <div className='fixed z-[100] w-full h-auto bg-black/30 backdrop-blur-sm overflow-x-hidden border-b-white'>
      <ul className='flex flex-row items-center justify-between my-4 mx-10'>
        <a href='/'>
          ...
          <div className='hidden bg-gray-700/30 py-2 lg:px-4 px-2 backdrop-blur-md lg:flex flex-row font-Kanit text-white rounded-md text-[14px] lg:text-[20px] xl:text-[22px] text-sm'>
